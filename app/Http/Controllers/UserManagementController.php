    ...
    public function profileInformation(Request $request)
    {
       ...
       $image_name = '';
            ...
            if ($request->hasFile('images') && $request->file('images')->isValid()) {
                ...
                $imageFile->move(public_path('assets/images'), $newName);
                if (!empty($oldImageName)) {
                    $oldImagePath = public_path('assets/images/' . $oldImageName);
                    if ($oldImageName !== 'photo_defaults.jpg' && file_exists($oldImagePath)) {
                        @unlink($oldImagePath);
                    }
                }
