...
@section('content')
   ...
   @php
    ...
    $hour = date('G');
    $currentTime = date('h:i A'); // 12-hour format with AM/PM (e.g., 02:45 PM)
    $todayDate = "Today is " . date("l, M. d, Y.") . " | time: " . $currentTime;
...
@endphp
    ...
    <h3>{{ $greet }} {{ Session::get('name') ?? 'Guest' }}!</h3>
    <p>{{ $todayDate }}</p>
</div>
                    </div>
                </div>
                        ...
                        <section>
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <h4 class="holiday-title mb-0">Mon 20 OCT 2025 - Diwali</h4>
                                </div>
                            </div>
                        </section>
                    </div>
