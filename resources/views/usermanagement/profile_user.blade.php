                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="profile-img-wrap edit-img">
                                     <img class="inline-block" src="{{ asset('assets/images/' . (Auth::user()->avatar ?? '489414913.jpg')) }}" alt="{{ Auth::user()->name ?? '' }}">

                                        <div class="fileupload btn">
                                            <span class="btn-text">edit</span>
                                            <input class="upload" type="file" id="image" name="images"  value="{{ asset('assets/images/' . $user->avatar) }}">
