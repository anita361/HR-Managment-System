...
Route::group(['namespace' => 'App\Http\Controllers'],function()
{
    ...
    // ---------------------- Family Information -----------------------//
Route::controller(FamilyInformationController::class)->group(function () {
    Route::middleware('auth')->group(function () {
        Route::post('family/information/save', 'saveRecord')->name('family/information/save'); // create or update
        Route::get('family/information/{id}', 'getRecord')->name('family/information/get'); // fetch single
        Route::delete('family/information/{id}', 'deleteRecord')->name('family/information/delete'); // delete
    });
});
